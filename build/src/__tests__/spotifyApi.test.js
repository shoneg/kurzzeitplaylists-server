...
describe('spotifyApi', () => {
    it('refreshAllSessions refreshes credentials before expireBefore', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, spotifyApi_1.refreshAllSessions)((0, moment_1.default)('2020-01-01T00:00:00Z'), { db });
